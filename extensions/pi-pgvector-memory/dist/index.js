...
const tools = [
    ...
    },
    {
        ...
        label: "Recall memory",
        description: "Search memory by semantic similarity to query. Optionally tag-filter (must equal a stored tag). Returns { results: [{evidence_id, content, tags, space_kind, valid_until, confidence}] }. Read content.",
        parameters: Type.Object({
    ...
    },
    {
        ...
        description: "Retire memory records by evidence_id (from recall). reason required. Returns { retracted: N }.",
        parameters: Type.Object({
    ...
    },
    {
        name: "pgvec_gc",
        label: "Memory GC",
        description: "Retire records whose valid_until has passed. Returns { scanned, retracted }. Called by QA after iterations.",
        parameters: Type.Object({
